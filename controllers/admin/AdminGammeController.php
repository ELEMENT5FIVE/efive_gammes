...
class AdminGammeController extends ModuleAdminController
{
    ...
    public function renderForm()
    {
        $this->fields_form = [
            'legend' => [
                'title' => $this->trans('Gamme', [], 'Modules.Elementfive.Admin'),
                'icon' => 'icon-cogs',
            ],
            'input' => [
                'id_gamme' => [
        ...
        $helper->token = Tools::getAdminTokenLite('AdminGamme');
        ...
        $helper->submit_action = 'submitAddGamme';
    ...
    public function getFormValues()
    {
        ...
        $idGamme = Gamme::getGammeIdByShop($idShop);

        Shop::setContext(Shop::CONTEXT_SHOP, $idShop);
        $gamme = new Gamme((int) $idGamme);

        $fields_value['id_gamme'] = $idGamme;
        $fields_value['name'] = $gamme->name;
